...
public extension User {
	public class func registerWithUsername(username: String, password: String, timeoutInterval: NSTimeInterval = Configuration.defaultTimeoutInterval, completionHandler: ((user: User?, error: ErrorType?) -> ())? = nil) {
	...
	public class func loginWithUsername(username: String, password: String, timeoutInterval: NSTimeInterval = Configuration.defaultTimeoutInterval, completionHandler: ((user: User?, error: ErrorType?) -> ())? = nil) {
	...
	private class func handleSignUpLogin(isSignUp signUp: Bool, username: String, password: String, timeoutInterval: NSTimeInterval = Configuration.defaultTimeoutInterval, completionHandler: ((user: User?, error: ErrorType?) -> ())? = nil) {
